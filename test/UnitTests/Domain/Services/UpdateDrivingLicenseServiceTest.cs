...
namespace UnitTests.Domain.Services
{
    public class UpdateDrivingLicenseServiceTest
    {
        ...
        [Fact]
        public async void ShouldUploadDrivingLicenseImageAndReturnPublicLinkFromStorage()
        {
            ...
            .ReturnsAsync(Either<Error, string>.RightValue($"https://qwdasfwsdas.supabase.co/storage/v1/s3/{fileName}"));
        ...
        [Fact]
        public async void ShouldReturnErrorWhenCnpjNotFound()
        {
        ...
        [Fact]
        public async void ShouldNotUpdateDrivingLicenseAndReturnExceptionHandling()
        {
            var cnpj = "97936986000148";
            var cancellationToken = CancellationToken.None;
            var mockFile = new Mock<IFormFile>();
